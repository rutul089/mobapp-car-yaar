...
class VehicleDetail extends Component {
  ...
  render() {
    ...
    let {UsedVehicle, model, trim, colour} = selectedVehicle || {};
    let manufactureYear = UsedVehicle?.manufactureYear;
    const lastUpdatedOn = this.safeGet(selectedVehicle, 'updatedAt');
    ...
    return (
      <Vehicle_Detail_Component
        ...
        make={this.safeGet(selectedVehicle, 'make')}
        ...
        vehicleInfo={[
          {label: 'Owner Name', value: this.safeGet(UsedVehicle, 'ownerName')},
          {
          ...
          {label: 'PUC', value: UsedVehicle?.PUCC ? 'Yes' : 'No'},
          {
            label: 'Ownership',
